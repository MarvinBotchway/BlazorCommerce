...
namespace BlazorCommerce.Server.Migrations
{
    ...
    [Migration("20220606113258_ProductVariantsSeeding")]
    partial class ProductVariantsSeeding
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorCommerce.Shared.ProductTypeModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorCommerce.Shared.ProductVariantModel", b =>
                {
            ...
            modelBuilder.Entity("BlazorCommerce.Shared.ProductVariantModel", b =>
                {
                    b.HasOne("BlazorCommerce.Shared.ProductModel", "Product")
                        .WithMany("Variants")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlazorCommerce.Shared.ProductTypeModel", "ProductType")
                        .WithMany()
